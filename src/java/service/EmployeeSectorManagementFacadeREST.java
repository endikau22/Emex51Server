...
public class EmployeeSectorManagementFacadeREST extends AbstractFacade<EmployeeSectorManagement> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") EmployeeSectorId id, EmployeeSectorManagement entity) {
        super.edit(entity);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<EmployeeSectorManagement> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<EmployeeSectorManagement> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
